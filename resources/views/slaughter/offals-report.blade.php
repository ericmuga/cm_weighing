        ...
        <div class="card">
            <div class="card-header row">
                ...
                <div class="col-md-5">
                    ...
                    <button class="btn btn-warning" data-toggle="modal" data-target="#export_summary"><i
                            class="fas fa-file-excel"></i>
                        Generate Offals Summary</button>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Export Offals Report Lines</h5>
...
<div class="modal fade" id="export_summary" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <form id="form-orders-export" action="{{ route('offals_report_export_summary') }}" method="post">
        @csrf
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Export Offals Summary</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
